...
const SvgElementReallityKit1 = (props: SVGProps<SVGSVGElement> = { width: 16, height: 16, color: '#000', strokeWidth: 1.5 }) => (
  <svg xmlns='http://www.w3.org/2000/svg' width={props.width} height={props.height} fill='none' viewBox='0 0 48 48' {...props}>
    <path stroke={props.color} strokeWidth={props.strokeWidth} d='M14.59 44a.5.5 0 1 1 0-1M14.59 44a.5.5 0 0 0 0-1' />
    <path
      stroke={props.color}
      strokeLinecap='round'
    ...
    />
    <path stroke={props.color} strokeLinecap='round' strokeLinejoin='round' strokeWidth={props.strokeWidth} d='M47 33.75a4 4 0 0 1-4 4' />
    <path
      stroke={props.color}
      strokeLinecap='round'
      strokeWidth={props.strokeWidth}
