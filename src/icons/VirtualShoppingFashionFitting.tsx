...
const SvgVirtualShoppingFashionFitting = (props: SVGProps<SVGSVGElement> = { width: 16, height: 16, color: '#000', strokeWidth: 1.5 }) => (
  <svg xmlns='http://www.w3.org/2000/svg' width={props.width} height={props.height} fill='none' viewBox='0 0 48 48' {...props}>
    ...
    <path
      ...
      strokeLinejoin='round'
      strokeWidth={props.strokeWidth}
      d='M28.04 24.505h2.524A.505.505 0 0 0 31.07 24v-3.534a4.039 4.039 0 0 0-4.039-4.039h-1.01a2.02 2.02 0 0 1-4.038 0h-1.01a4.039 4.039 0 0 0-4.04 4.039V24a.505.505 0 0 0 .506.505h2.524M46.876 16.427h-1.01a2.02 2.02 0 0 1-4.038 0h-1.01a4.039 4.039 0 0 0-4.039 4.039V24a.505.505 0 0 0 .505.505h2.524M1.126 16.427h1.01a2.02 2.02 0 1 0 4.038 0h1.01a4.039 4.039 0 0 1 4.039 4.039V24a.505.505 0 0 1-.505.505H8.194M40.095 23.066h6.2M40.095 26.524h6.2'
    />
    <path
      stroke={props.color}
      strokeLinecap='round'
