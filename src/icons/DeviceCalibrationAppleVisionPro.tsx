...
const DeviceCalibrationAppleVisionPro = ({
  width = 24,
  height = 24,
  color = '#000',
  strokeWidth = 1.5,
  ...
  <svg xmlns='http://www.w3.org/2000/svg' width={width} height={height} fill='none' viewBox='0 0 48 48' {...props}>
    ...
    />
    <circle cx={35.5} cy={32.572} r={7.333} stroke={color} strokeWidth={strokeWidth} transform='rotate(180 35.5 32.572)' />
    <path stroke={color} strokeLinecap='round' strokeLinejoin='round' strokeWidth={strokeWidth} d='M35.5 43.572v-22M24.5 32.572h22' />
    <path
      stroke={color}
      strokeLinecap='round'
      strokeWidth={strokeWidth}
