...
const SvgVirtualDisplayLaptop = (props: SVGProps<SVGSVGElement> = { width: 16, height: 16, color: '#000', strokeWidth: 1.5 }) => (
  <svg xmlns='http://www.w3.org/2000/svg' width={props.width} height={props.height} fill='none' viewBox='0 0 48 48' {...props}>
    <g stroke={props.color} strokeLinejoin='round' strokeWidth={props.strokeWidth} clipPath='url(#virtual-display-laptop_svg__a)'>
      <path
        strokeLinecap='round'
