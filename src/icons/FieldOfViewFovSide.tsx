...
const SvgFieldOfViewFovSide = (props: SVGProps<SVGSVGElement> = { width: 16, height: 16, color: '#000', strokeWidth: 1.5 }) => (
  <svg xmlns='http://www.w3.org/2000/svg' width={props.width} height={props.height} fill='none' viewBox='0 0 48 48' {...props}>
    ...
    />
    <path stroke={props.color} strokeLinecap='round' strokeWidth={props.strokeWidth} d='M23.988 19.14a3.277 3.277 0 0 0-4.635 0' />
    <path stroke={props.color} strokeWidth={props.strokeWidth} d='M21.67 22.548a.484.484 0 0 1 0-.968M21.67 22.548a.484.484 0 1 0 0-.969' />
    <path
      stroke={props.color}
      strokeLinecap='round'
      strokeWidth={props.strokeWidth}
