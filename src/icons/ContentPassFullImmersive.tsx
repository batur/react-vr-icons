...
const ContentPassFullImmersive = ({ width = 24, height = 24, color = '#000', strokeWidth = 1.5, ...props }: SVGProps<SVGSVGElement>) => (
  <svg xmlns='http://www.w3.org/2000/svg' width={width} height={height} fill='none' viewBox='0 0 48 48' {...props}>
    ...
    <path
      ...
      strokeLinejoin='round'
      strokeWidth={strokeWidth}
      d='M26.877 14.484s-2.53.142-2.859 1.908c-.329 1.766 1.257 2.62 4.343 2.108.399-1.5-.38-3.213-1.484-4.024Z'
    />
  </svg>
);
