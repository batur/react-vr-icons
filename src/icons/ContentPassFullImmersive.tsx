...
const SvgContentPassFullImmersive = (props: SVGProps<SVGSVGElement> = { width: 16, height: 16, color: '#000', strokeWidth: 1.5 }) => (
  <svg xmlns='http://www.w3.org/2000/svg' width={props.width} height={props.height} fill='none' viewBox='0 0 48 48' {...props}>
    ...
    />
    <path stroke={props.color} strokeWidth={props.strokeWidth} d='M25.182 14.964a3.322 3.322 0 1 0 2.134 3.665' />
    <path
      stroke={props.color}
      strokeLinecap='round'
      strokeLinejoin='round'
