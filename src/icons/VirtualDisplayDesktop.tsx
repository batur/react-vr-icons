...
const SvgVirtualDisplayDesktop = ({ width = 16, height = 16, color = '#000', strokeWidth = 1.5, ...props }: SVGProps<SVGSVGElement>) => (
  <svg xmlns='http://www.w3.org/2000/svg' width={width} height={height} fill='none' viewBox='0 0 48 48' {...props}>
    <g stroke={color} strokeLinejoin='round' strokeWidth={strokeWidth} clipPath='url(#virtual-display-desktop_svg__a)'>
      ...
      <path
        strokeLinecap='round'
        d='M35.338 25.962v-13.17M19.014 17.754H3.51c-1.196 0-2.165.97-2.165 2.165v18.315c0 1.195.97 2.164 2.165 2.164h28.137a2.164 2.164 0 0 0 2.165-2.164V31.08M8.921 46.892h17.316M1.346 35.533h32.466M14.877 40.425l-3.07 6.466M20.282 40.425l3.07 6.466'
      />
    </g>
    <defs>
