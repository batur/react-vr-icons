...
const HeadLockContentMovement = ({ width = 24, height = 24, color = '#000', strokeWidth = 1.5, ...props }: SVGProps<SVGSVGElement>) => (
  <svg xmlns='http://www.w3.org/2000/svg' width={width} height={height} fill='none' viewBox='0 0 48 48' {...props}>
    <g stroke={color} strokeWidth={strokeWidth} clipPath='url(#head-lock-content-movement_svg__a)'>
      ...
      <path strokeLinecap='round' d='m24.247 18.881 5.657-5.656' />
      <path
        strokeLinejoin='round'
      ...
      <path
        strokeLinecap='round'
        d='m26.685 26.923-2.122-2.121M21.735 21.974l-2.122-2.122M8.285 8.524 6.244 6.403M3.335 3.574 1.214 1.453'
      />
    </g>
    <defs>
...
const Memo = memo(HeadLockContentMovement);
export default Memo;
