...
const VirtualEnvironmentForest = ({ width = 24, height = 24, color = '#000', strokeWidth = 1.5, ...props }: SVGProps<SVGSVGElement>) => (
  <svg xmlns='http://www.w3.org/2000/svg' width={width} height={height} fill='none' viewBox='0 0 48 48' {...props}>
    ...
    <path
      ...
      strokeWidth={strokeWidth}
      d='M18.89 33.49v6.255M28.834 33.49v6.255M24.218 33.49a.874.874 0 0 0 .76-1.307l-2.749-5.684h2.622l-3.496-6.118h2.622l-4.524-6.777a.874.874 0 0 0-1.454 0L13.49 20.38h2.622l-3.496 6.117h2.622l-2.749 5.684a.874.874 0 0 0 .759 1.31h10.97ZM27.62 33.49h6.037a.768.768 0 0 0 .667-1.15l-2.424-4.996h2.305l-3.073-5.377h2.304l-3.97-5.958a.77.77 0 0 0-1.278 0l-1.66 2.643'
    />
  </svg>
);
