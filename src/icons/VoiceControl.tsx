...
const SvgVoiceControl = (props: SVGProps<SVGSVGElement> = { width: 16, height: 16, color: '#000', strokeWidth: 1.5 }) => (
  <svg xmlns='http://www.w3.org/2000/svg' width={props.width} height={props.height} fill='none' viewBox='0 0 48 48' {...props}>
    <g stroke={props.color} strokeLinecap='round' strokeWidth={props.strokeWidth} clipPath='url(#voice-control_svg__a)'>
      <path d='M44.757 21.502a10.464 10.464 0 0 0 2.138-6.343v-1.324A12.254 12.254 0 0 0 35.726 1.629l-3.701-.33a90.638 90.638 0 0 0-16.05 0l-3.707.33a12.248 12.248 0 0 0-11.163 12.2v1.305A10.5 10.5 0 0 0 8.62 25.201a11.666 11.666 0 0 0 11.063-2.464l2.102-1.867a3.345 3.345 0 0 1 4.436-.006l2.157 1.905c.356.315.728.605 1.114.87' />
...
const Memo = memo(SvgVoiceControl);
export default Memo;
