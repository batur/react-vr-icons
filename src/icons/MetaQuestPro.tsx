...
const SvgMetaQuestPro = ({ width = 16, height = 16, color = '#000', strokeWidth = 1.5, ...props }: SVGProps<SVGSVGElement>) => (
  <svg xmlns='http://www.w3.org/2000/svg' width={width} height={height} fill='none' viewBox='0 0 48 48' {...props}>
    ...
    />
    <circle cx={16.074} cy={32.283} r={2.988} stroke={color} strokeWidth={strokeWidth} />
