...
const SvgToolsRealityComposerPro = ({ width = 16, height = 16, color = '#000', strokeWidth = 1.5, ...props }: SVGProps<SVGSVGElement>) => (
  <svg xmlns='http://www.w3.org/2000/svg' width={width} height={height} fill='none' viewBox='0 0 48 48' {...props}>
    ...
    />
    <path stroke={color} strokeLinejoin='round' strokeWidth={strokeWidth} d='m16.686 14.884 7.25-4.114 7.249 4.114' />
    <path
      stroke={color}
      strokeLinejoin='round'
      strokeWidth={strokeWidth}
