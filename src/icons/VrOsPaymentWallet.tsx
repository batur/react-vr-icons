...
const SvgVrOsPaymentWallet = (props: SVGProps<SVGSVGElement> = { width: 16, height: 16, color: '#000', strokeWidth: 1.5 }) => (
  <svg xmlns='http://www.w3.org/2000/svg' width={props.width} height={props.height} fill='none' viewBox='0 0 48 48' {...props}>
    ...
    <path
      stroke={props.color}
      strokeWidth={props.strokeWidth}
      d='M22.176 26.894a.712.712 0 1 1 0-1.423M22.176 26.894a.712.712 0 0 0 0-1.423'
    />
    <path
      stroke={props.color}
      strokeLinecap='round'
