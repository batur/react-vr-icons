...
const SvgVrSupportedMediaFile4 = (props: SVGProps<SVGSVGElement> = { width: 16, height: 16, color: '#000', strokeWidth: 1.5 }) => (
  <svg xmlns='http://www.w3.org/2000/svg' width={props.width} height={props.height} fill='none' viewBox='0 0 48 48' {...props}>
    <path
      ...
      d='M16.023 34.877h15.904a1.5 1.5 0 0 0 1.5-1.5V20.25a1.45 1.45 0 0 0-.425-1.025l-5.677-5.678a1.45 1.45 0 0 0-1.025-.424H16.023c-.79 0-1.45.66-1.45 1.45v18.854c0 .79.66 1.45 1.45 1.45Z'
    />
    <path
      stroke={props.color}
      strokeLinecap='round'
...
const Memo = memo(SvgVrSupportedMediaFile4);
export default Memo;
