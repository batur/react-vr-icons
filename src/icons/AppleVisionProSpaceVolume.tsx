...
const AppleVisionProSpaceVolume = ({ width = 24, height = 24, color = '#000', strokeWidth = 1.5, ...props }: SVGProps<SVGSVGElement>) => (
  <svg xmlns='http://www.w3.org/2000/svg' width={width} height={height} fill='none' viewBox='0 0 48 48' {...props}>
    ...
    >
      <path d='M38.782 35.906V24.18L19.92 5.474M38.824 24.243l7.867-4.466M27.85 1.572v2.822M27.85 8.345v2.822M27.85 15.117v2.822' />
      <path d='m28.965 1.236 24.931 9.61a2.257 2.257 0 0 1 1.143 1.963v17.597c0 .813-.436 1.563-1.143 1.964l-6 3.404a2.258 2.258 0 0 1-2.228 0l-24.932-9.61a2.257 2.257 0 0 1-1.143-1.963V6.605c0-.812.436-1.562 1.142-1.963l6.001-3.406a2.257 2.257 0 0 1 2.229 0ZM42.806 29.51l3.773 2.097M39.42 27.587l-3.386-1.921M29.261 21.776l3.104 1.807M26.157 21.722l-3.104 1.808' />
...
const Memo = memo(AppleVisionProSpaceVolume);
export default Memo;
