...
const SvgVoiceControl2 = (props: SVGProps<SVGSVGElement> = { width: 16, height: 16, color: '#000', strokeWidth: 1.5 }) => (
  <svg xmlns='http://www.w3.org/2000/svg' width={props.width} height={props.height} fill='none' viewBox='0 0 48 48' {...props}>
    <g stroke={props.color} strokeLinecap='round' strokeWidth={props.strokeWidth} clipPath='url(#voice-control-2_svg__a)'>
      <path d='M44.757 22.002a10.464 10.464 0 0 0 2.138-6.344v-1.324A12.254 12.254 0 0 0 35.726 2.128L32.025 1.8a90.635 90.635 0 0 0-16.05 0l-3.707.33a12.248 12.248 0 0 0-11.163 12.2v1.305A10.5 10.5 0 0 0 8.62 25.7a11.666 11.666 0 0 0 11.063-2.463l2.102-1.867a3.345 3.345 0 0 1 4.436-.007l2.157 1.906c.356.314.728.604 1.114.87' />
