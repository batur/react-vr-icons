...
const HapticSensorVibrationController2 = (props: SVGProps<SVGSVGElement> = { width: 24, height: 24, color: '#000', strokeWidth: 1.5 }) => (
  <svg xmlns='http://www.w3.org/2000/svg' width={width} height={height} fill='none' viewBox='0 0 48 48' {...props}>
    <g stroke={color} strokeWidth={strokeWidth} clipPath='url(#haptic-sensor-vibration-controller-2_svg__a)'>
      <path
        strokeLinecap='round'
        d='M24.808 5.386c-8.405 0-10.507 7.005-10.507 10.507 0 7.004 3.036 11.44 10.507 10.507 9.34-1.248 15.176-5.837 15.176-10.507S35.314 5.386 24.808 5.386Z'
      />
      <path
        strokeLinecap='round'
        strokeLinejoin='round'
        d='M14.3 15.893v24.515c0 1.946 1.248 5.837 5.838 5.837s5.837-3.89 5.837-5.837v-7.004c2.548-3.397 7.701-8.303 11.26-12.037'
      />
...
const Memo = memo(HapticSensorVibrationController2);
export default Memo;
