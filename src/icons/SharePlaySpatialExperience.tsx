...
const SharePlaySpatialExperience = ({ width = 24, height = 24, color = '#000', strokeWidth = 1.5, ...props }: SVGProps<SVGSVGElement>) => (
  <svg xmlns='http://www.w3.org/2000/svg' width={width} height={height} fill='none' viewBox='0 0 48 48' {...props}>
    <g stroke={color} strokeLinecap='round' strokeWidth={strokeWidth} clipPath='url(#share-play-spatial-experience_svg__a)'>
      ...
      <path
        strokeLinejoin='round'
        d='M14.248 33.73a6.76 6.76 0 0 0-13.519 0v2.898h2.897l.966 7.725h5.794l.965-7.725h2.897V33.73ZM47.24 33.73a6.76 6.76 0 0 0-13.52 0v2.898h2.898l.965 7.725h5.794l.966-7.725h2.897V33.73ZM30.052 24.586a6.052 6.052 0 1 0-12.105 0v2.594h2.594l.865 6.917h5.188l.864-6.917h2.594v-2.594Z'
      />
    </g>
    <defs>
...
const Memo = memo(SharePlaySpatialExperience);
export default Memo;
