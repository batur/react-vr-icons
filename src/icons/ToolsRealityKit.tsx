  ...
  <svg xmlns='http://www.w3.org/2000/svg' width={width} height={height} fill='none' viewBox='0 0 48 48' {...props}>
    <g stroke={color} strokeWidth={strokeWidth} clipPath='url(#tools-reality-kit_svg__a)'>
      <path
        ...
        d='M24.043 15.459 2.5 23.145a2 2 0 0 0-1.013 1.74v8.832a2 2 0 0 0 1.013 1.74l20.448 11.605a2 2 0 0 0 1.974 0L45.37 35.456a2 2 0 0 0 1.013-1.74v-8.831a2 2 0 0 0-1.013-1.74l-5.312-3.015'
      />
