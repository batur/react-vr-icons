...
const SvgHeadLockContentWindow = (props: SVGProps<SVGSVGElement> = { width: 16, height: 16, color: '#000', strokeWidth: 1.5 }) => (
  <svg xmlns='http://www.w3.org/2000/svg' width={props.width} height={props.height} fill='none' viewBox='0 0 48 48' {...props}>
    ...
    />
    <path stroke={props.color} strokeLinecap='round' strokeWidth={props.strokeWidth} d='M19.5 37h14' />
    <path
      stroke={props.color}
      strokeLinecap='round'
...
const Memo = memo(SvgHeadLockContentWindow);
export default Memo;
