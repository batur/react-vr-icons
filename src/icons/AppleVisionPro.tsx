...
const SvgAppleVisionPro = (props: SVGProps<SVGSVGElement> = { width: 16, height: 16, color: '#000', strokeWidth: 1.5 }) => (
  <svg xmlns='http://www.w3.org/2000/svg' width={props.width} height={props.height} fill='none' viewBox='0 0 48 48' {...props}>
    <circle cx={11.724} cy={22.5} r={1.744} stroke={props.color} strokeWidth={props.strokeWidth} />
    <path
      stroke={props.color}
      strokeLinecap='round'
...
const Memo = memo(SvgAppleVisionPro);
export default Memo;
